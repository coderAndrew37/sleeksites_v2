    ...
    <footer className="bg-white border-t border-slate-100">
      ...
      <div className="max-w-7xl mx-auto px-6 -mt-10 mb-20">
        <div className="bg-blue-600 rounded-[3rem] p-8 md:p-16 flex flex-col md:flex-row items-center justify-between gap-8 shadow-2xl shadow-blue-200 overflow-hidden relative">
          ...
          <Link
            href="/contact"
            className="relative z-10 group bg-white text-blue-600 px-8 py-5 rounded-2xl font-black uppercase tracking-widest text-sm flex items-center gap-3 hover:bg-slate-900 hover:text-white transition-all duration-500 shadow-xl"
          >
            Start a Project
            <ArrowUpRight
              size={20}
        ...
        <div className="grid grid-cols-2 md:grid-cols-12 gap-y-12 gap-x-8 mb-20">
          ...
          <div className="col-span-2 md:col-span-2">
            ...
            <ul className="space-y-4">
              <li>
                <a
                  href="mailto:hello@sleeksites.co.ke"
